...
module.exports = (app) => {
  ...
  const _websocket = middleware.websocket(app);
  ...
  router.get('/api/user/get_user_id', controller.user.getUserInfoById); // 修改用户个性签名
  ...
  router.get('/api/news/list', controller.news.query); //获取新闻列表
